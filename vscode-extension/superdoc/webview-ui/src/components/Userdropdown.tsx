...
const Userdropdown = ({email, profileRef, user_id}: {email: string, profileRef: any, user_id: string}) => {
    ...
    return (
        <div ref={profileRef} className="w-[200px] sm:w-[300px] bg-white z-[999] ring ring-primary absolute right-4 px-4 py-[7px] flex flex-col gap-y-2 rounded-xl shadow-2xl">
